...
Before the AI child starts teaching its generated game, the runner completes the same two foundation tasks as the browser:
...
Only then does the AI child invent and teach one small original game.
...
- the learner-authored game reaches a grounded ending;
...
```bash
export DIFY_TEST_VERSION='v12-r1'
...
```text
v12-listener-reconstruction-game-r1-20260823
```
